...
import com.bilgeadam.springrest.repository.*;

@RestController
@RequestMapping(path = "dersogrenci")
public class DersOgrenciController
{
	private DersOgrenciRepository dersRepository;

	public DersOgrenciController(DersOgrenciRepository dersRepository)
	{
		this.dersRepository = dersRepository;
	}

	@PostMapping(path = "save", consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<String> save(@RequestBody DersOgrenci ders)
	{
